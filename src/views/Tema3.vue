...
.curso-main-container.pb-3
  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5
    ...
    .row.mb-5.slideInUp
      .col-lg-5
        figure(data-aos="flip-up")
          img(src='@/assets/curso/t3-i1.png', alt='Gondola de exhibicion sin productos')
      .col-lg-7
    ...
    p.mb-5  En el punto de venta hay diferentes tipos de muebles y usos para los mismos, los siguientes son los tipos de mobiliarios más comunes:
    ...
    .row.mb-5
      ...
      .col-lg-5
        figure
          img(src='@/assets/curso/t3-i3.jpg', alt='operario de supermercado frente a mueble tipo góndola')

    p.mb-5  Las referencias se clasifican, entonces, en los siguientes tres niveles:

    TabsC.color-primario.mb-5
      .py-3.py-md-4(titulo="Artículos con rotación A")
      ...
      .py-3.py-md-4(titulo="Artículos con rotación C")
        .row.justify-content-center
          .col-md-3
            figure
    ...
    .neg-margin-x.bg-curved
      ...
      p.mb-5.text-bold  Adicionalmente, a este Método ABC, se le puede sumar un cuarto nivel:
      ...
      .row.mb-5
        .col-lg-9
          ...
          p.mb-3  <b>Ejemplos:</b> sección de productos de baja rotación, pero alta implicación tales como artículos de telefonía, informática e imagen y sonido. Como son categorías que tienen artículos de alta implicación, su ubicación en el punto de venta apunta de manera estratégica hacia un lugar donde un asesor pueda, de manera especializada y personalizada, atender a los clientes. Mobiliario como mostradores y puntos de información son necesarios para poder canalizar y materializar una venta (Borja, 2021).
        .col-lg-3
          figure(data-aos="slide-right")
            img(src='@/assets/curso/t3-i7.png', alt='imagen decorativa')
      ...
      TabsA.color-acento-botones.mb-5
        .tarjeta.color-acento-contenido.p-4(titulo="Penetración")
          .row
            .col-lg-7
              h4 Penetración
              p Precios por debajo del valor de venta al inicio del ciclo de vida para crear atracción estimulando al cliente a su compra. Luego, el precio comienza a estabilizarse en su valor monetario de venta. Es muy común en productos de lanzamiento o introducción al mercado, para darse a conocer más rápido.
            .col-lg-5
              figure(data-aos="slide-right")
                img(src='@/assets/curso/t3-i10.png', alt='imagen decorativa')     

        .tarjeta.color-acento-contenido.p-4(titulo="Desnatado o descremado")
          .row
            .col-lg-7
              h4 Desnatado o descremado
        ...
        .tarjeta.color-acento-contenido.p-4(titulo="Descuento por cantidad o volumen")
          .row
            .col-lg-7
              h4 Descuento por cantidad o volumen
